...
import type {FormatAction} from '@/components/richTextEditor/types'
...
import {ShortcutKey} from '@/components/richTextEditor/components/shortcut-key'
import {getShortcutKey} from '@/components/richTextEditor/utils'
