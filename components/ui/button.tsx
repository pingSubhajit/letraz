...
const buttonVariants = cva(
	...
	'focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:-translate-y-0.5',
	{
		variants: {
			variant: {
				default: 'bg-flame-500 text-primary-foreground hover:bg-flame-500/90',
