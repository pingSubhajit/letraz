...
import EducationTitle from '@/components/resume/themes/DEAFULT_THEME/sections/EducationTitle'
import ExperienceTitle from '@/components/resume/themes/DEAFULT_THEME/sections/ExperienceTitle'
