	...
	return (
		<div className="min-h-screen py-32">
			<div className="max-w-[720px] mx-auto font-bold">
				...
				<h1 className="mt-6 text-5xl leading-snug tracking-tight">News & updates about the development</h1>
				<h2 className="mt-4 text-lg opacity-70 max-w-[75%]">Join our <a href={discordHandle} target="_blank" className="font-semibold text-flame-500 focus-visible:underline hover:underline">Discord</a> to stay connected to more frequent updates and help us build the community</h2>
