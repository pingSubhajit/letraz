		...
		<AnimatePresence>
			<motion.video
				...
				initial={{scale: 0}} animate={{
					scale: onboardingStep === OnboardingStep.WELCOME || onboardingStep === OnboardingStep.EDUCATION ? 1 : 1.2,
					top: onboardingStep === OnboardingStep.WELCOME || onboardingStep === OnboardingStep.EDUCATION ? '0' : '-50%',
					right: onboardingStep === OnboardingStep.EDUCATION ? '-25%' : '0',
				}} exit={{scale: 0}}
				transition={{
					type: 'spring',
					duration: 1,
