	...
	return (
		<>
			...
			<div className="h-screen overflow-hidden flex justify-center lg:justify-end items-center w-screen">
				...
				<div className="w-full overflow-y-auto max-w-lg lg:w-[50vw] lg:max-w-none h-screen sm:h-auto sm:max-h-[90vh] sm:rounded-3xl lg:h-screen lg:max-h-none lg:rounded-none bg-neutral-50 flex flex-col justify-center items-start shadow-2xl p-6 sm:p-8 md:p-12 lg:p-24 xl:p-28 2xl:p-48">
					{children}
				</div>
			</div>
		</>
